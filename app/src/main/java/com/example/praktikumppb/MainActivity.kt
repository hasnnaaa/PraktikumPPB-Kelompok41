...
fun AnimeApp() {
    ...
    Scaffold(
                    ...
                    NavigationBarItem(
                        icon = {
                            when (screen) {
                                ...
                                Screen.Character -> Icon(Icons.Default.Person, contentDescription = "Character")
        ...
        NavHost(
            ...
            composable(
                route = Screen.AnimeDetail.route, arguments = listOf(navArgument("animeId") { type = NavType.IntType })
            ) {
